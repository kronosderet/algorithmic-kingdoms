...
DIFFICULTY_PROFILES = {
    "easy": {
        "start_gold": 300, "start_wood": 150, "start_iron": 0, "start_steel": 0, "start_stone": 0, "start_tonic": 20,
        "start_workers": 4,
        "kill_bounty_base": 5,
    ...
    "medium": {
        "start_gold": 200, "start_wood": 100, "start_iron": 0, "start_steel": 0, "start_stone": 0, "start_tonic": 0,
        "start_workers": 3,
        "kill_bounty_base": 4,
    ...
    "hard": {
        "start_gold": 180, "start_wood": 100, "start_iron": 0, "start_steel": 0, "start_stone": 0, "start_tonic": 0,
        "start_workers": 3,
        "kill_bounty_base": 2,
...
# ---------------------------------------------------------------------------
# v10_zeta: Tonic Resource — Tree of Life production & healing
# ---------------------------------------------------------------------------
TONIC_BASE_RATE = 0.5                  # tonic/sec at Tree iteration 0
TONIC_DEPTH_MULT = 0.3                 # bonus tonic/sec per Tree iteration level
TONIC_HEAL_COST = 5                    # tonic spent per heal tick
TONIC_HEAL_RATE = 2.0                  # HP restored per second when healing
TONIC_HEAL_RADIUS = 128.0             # px — heal radius around Tree of Life
TONIC_HEAL_INTERVAL = 2.0             # seconds between heal ticks

# ---------------------------------------------------------------------------
# v10_zeta: Resource Ecology — regrowth timers
# ---------------------------------------------------------------------------
REGROWTH_TIME = {
    TERRAIN_TREE: 120,     # 2 min — trees regrow fastest
    TERRAIN_GOLD: 300,     # 5 min
    TERRAIN_IRON: 240,     # 4 min
    TERRAIN_STONE: 360,    # 6 min — stone is slowest
}
...
COL_TONIC = (180, 220, 100)        # green-gold: the Tree's restorative essence
COL_SELECT = (0, 255, 0)
...
TOOLTIP_DATA = {
    ...
    "res_tonic": "Tonic — Restorative essence.\nGenerated by the Tree of Life.\nHeals nearby damaged units.",
    # --- Population ---
    ...
    # --- Buildings ---
    "bld_town_hall": "Tree of Life — Main structure.\nTrains Gatherers. Generates Tonic.\nHeals nearby units. Garrison for defense.",
